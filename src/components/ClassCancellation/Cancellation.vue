    ...
    <v-main style="padding-left: 0%;">
        ...
        <div class="mb-5">
            <v-row>
                ...
                <v-col cols="auto">
                <span class="text-attention">Para cancelar una asignatura debes seleccionarla primero y luego dar clic en el botón cancelar.</span>
                </v-col>
            </v-row>
        </div>
        <v-card>
            ...
            <v-card-text class="mt-1" style="padding: 0;">
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="item in student" :key="item.name" :class="{ 'selected-row': item.selected }">
                        <td>
