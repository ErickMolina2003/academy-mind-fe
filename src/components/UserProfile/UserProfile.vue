            ...
            <v-col class="text-right">
                ...
                <v-dialog v-model="dialogOpen" persistent max-width="1000px">
                    <v-card>
                        ...
                        <v-card-text>
                            <MyDialog @close="closeDialog" @update-profile="updateProfile" :user-profile="userProfile">
                            </MyDialog>
                        </v-card-text>
                    </v-card>
                </v-dialog>
        ...
        <v-row class="pt-6" style="padding-bottom: 15px">
            <v-col cols="12" class="user-info rounded-lg mb-6 px-7 py-6">
                ...
                <v-row v-if="profileVideo">
                    <v-col cols="12">
                        <v-card variant="outlined" class="mx-auto" width="850" color="grey lighten-4">
                ...
                <v-sheet class="mx-auto" max-width="900">
                    <v-slide-group class="pa-1" center-active show-arrows>
                        <v-slide-group-item v-for="section in sections" :key="section.id">
                            <ClassCard max-width="352" class="mr-1" v-if="userIsTeacher" :clase="section.idClass.name"
                                :periodo="section.idPeriod.numberPeriod" :anio="section.idPeriod.year" />
                            <ClassCard max-width="352" class="mr-1" v-if="!userIsTeacher"
                                :clase="section.section.idClass.name" periodo="2" anio="2023" />
                        </v-slide-group-item>
                    </v-slide-group>
                </v-sheet>
            </v-col>
